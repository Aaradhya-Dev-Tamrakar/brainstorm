...
- **Clean-Slate GPU & RAM Architecture Research:** Initiated 2026-09-13 exploring open-source predecessors (Vortex RISC-V GPGPU, LiteDRAM, Ramulator 2.0) to bypass gatekept proprietary accelerators via discrete event simulation, smart memory coalescing, and near-memory computing ([`GPU_RAM_ARCHITECTURE_SPEC.md`](research/experiments/GPU_RAM_ARCHITECTURE_SPEC.md) & [`INV-MEM-001`](research/invariants/INV-MEM-001.md)).
