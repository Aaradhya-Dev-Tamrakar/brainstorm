...
![Ontology: 23 Modules | 19 Computational](https://img.shields.io/badge/Ontology-23%20Modules%20%7C%2019%20Computational-indigo)
...
- 📖 **[Canonical Capability & Ecosystem Ontology](schemas/capability-ontology.md):** Formal definitions of Repository $\to$ Project $\to$ Capability $\to$ Interface $\to$ Workflow.  
  _Canonical Inventory:_ **23 Tool Modules** | **19 Computational Engines** | **4 Presentation Hubs** | **6 Compound Workflows** | **31 Research Specs & Experiments**.
...
┌───────────────────────────────────────▼────────────────────────────────────────┐
│ 3. CAPABILITY MESH (19 Computational Engines across 23 Modules)               │
